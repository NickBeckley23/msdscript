...
TEST_CASE("Expression Tests"){
    ...
    Expr *let4 = new Let("x",new Var("x"),new Add(new Var("x"), new Num(2)));
    CHECK((let4->subst("x", new Num(5))->equals(new Let("x",new Num(5),new Add (new Var("x"), new Num(2))))));

    Expr *let5 = new Let ("x", new Num(8), new Add (new Var("x"), new Var("y")));
    CHECK((let5-> subst("y", new Num(9)))->equals(new Let ("x", new Num(8),new Add (new Var("x"), new Num(9)))));

    Expr *let6 = new Let ("x",new Var ("y"),new Add (new Var("x"), new Var("y")));
    CHECK((let6-> subst("y", new Num(9)))->equals(new Let ("x", new Num(9),new Add (new Var("x"), new Num(9)))));
    ...
    pp_let1 = "_let x = 5\n_in  x + 1";
    CHECK ((new Let("x", new Num(5), new Add(new Var("x"), new Num(1))))->pp_to_string() == pp_let1);
           
    pp_let1 = "_let x = 5\n_in  _let x = 2\n     _in  x + 3";
    CHECK ((new Let("x", new Num(5), new Let("x", new Num(2), new Add( new Var("x"), new Num(3)))))->pp_to_string()== pp_let1);
    ...
    CHECK( (new Var("x"))->subst("y", new Var("y"))->equals(new Var("x")) == true);
    ...
    CHECK ((new Mult(new Mult( new Mult( new Num(3), new Num(4)), new Mult( new Num(5), new Num(6))), new Add( new Num(7), new Num(8))))->pp_to_string() == testString);
           
    testString = "((a + b) * 7) * 6 * c";
    CHECK ((new Mult(new Mult( new Add( new Var("a"), new Var("b")), new Num(7)), new Mult( new Num(6), new Var("c"))))->pp_to_string() == testString);
